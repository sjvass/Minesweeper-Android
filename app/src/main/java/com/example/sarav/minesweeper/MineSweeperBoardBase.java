 ...
 * interface for the game. This abstract base class defines the basic features
 * of a MineSweeperBoard, which you must create.
 *
 * @version 2011.08.15
...
public abstract class MineSweeperBoardBase
{
     ...
     *
     * @param x
     *            the column containing the cell. (width)
     * @param y
     *            the row containing the cell. (height)
     ...
     * @return boolean that represents whether objects are equal
     */
     ...
     * following conventions: O = covered cell F = flag M = flagged mine + =
     * covered mine * = uncovered mine (about to explode!) 1..9 or space =
     * uncovered cell
     *
     * @return String representation of board values
     */
